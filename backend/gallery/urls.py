...
urlpatterns = [
    ...
    path(
        "favourites/<str:email>/<int:start_index>/<int:end_index>/",
        views.getFavouritesArchive,
        name="get_favourites_archive",
    ),
    ...
    path("log_user_visit/", views.log_user_visit, name="log_user_visit"),
]

...
if DEBUG:
    SECRET_KEY = "dummy-debug-secret-key"
else:
...
DJOSER = {
    ...
    "SERIALIZERS": {
        "user_create": "gallery.serializers.UserCreateSerializer",
        "user": "gallery.serializers.UserCreateSerializer",
...
AUTH_USER_MODEL = "gallery.UserAccount"
